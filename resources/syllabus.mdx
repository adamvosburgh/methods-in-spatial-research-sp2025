...
| 2/21 | 5 |  Making Data from Satellites | Tutorial 4 |  Assignment 3 |
| 2/28 | 6 |  Maps & Narrative | Tutorial 5 OR Tutorial 6 |  Assignment 4 |
| 3/28 |  | Portfolio Due | | Assignment 5 (for extra credit) |



## Weekly Schedule, Readings, & Assignments
All course tutorials and assignments will be posted [here](https://adamvosburgh.github.io/methods-in-spatial-research-sp2025/) on the course website.
