...
const TutorialsPage=({data})=>{return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_layout__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,{pageTitle:"Tutorials"},data.allMdx.nodes.map(node=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("article",{key:node.id},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h2",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link,{to:`/tutorials/${node.slug}`},node.frontmatter.sequence," ",node.frontmatter.title)))));};const query="1327770028";/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TutorialsPage);

/***/ })

};
;
//# sourceMappingURL=component---src-pages-tutorials-index-js.js.map