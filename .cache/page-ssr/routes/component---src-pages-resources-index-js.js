...
const ResourcesPage=({data})=>{return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_layout__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,{pageTitle:"Resources"},data.allMdx.nodes.map(node=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("article",{key:node.id},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h2",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link,{to:`/resources/${node.slug}`},node.frontmatter.sequence," ",node.frontmatter.title)))));};const query="4082737494";/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ResourcesPage);

/***/ })

};
;
//# sourceMappingURL=component---src-pages-resources-index-js.js.map